...
Also note that after you type a command, you have to press the `Enter`</kbd>` key to execute it.
...
This might happen if the command was mis-typed or if the ogram corresponding to that command
is not installed.
